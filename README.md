...
Multi-dimensional risk signals system for content moderation in online communities (Reddit). Combines toxicity detection, polarity analysis, and controversy scoring to help moderators prioritize review queues without automating removal decisions.
